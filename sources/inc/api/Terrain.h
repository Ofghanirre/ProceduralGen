 ...
 * 
 * The predicate is a function applyable to the old value present in before the execution of this TerrainNode
 * It can be usefull if you want to apply the terrainNode NoiseGenerator based on some previous value
*/
struct TerrainNode {
